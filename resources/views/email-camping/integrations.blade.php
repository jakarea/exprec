...
<div class="row integration-top-margin">
  ...
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
    <!-- integration platform filter wrap @S -->
    <div class="row integration-top-margin">
        <div class="col-12">
            <div class="platform-tab-head">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-woocommerce-tab" data-bs-toggle="pill" data-bs-target="#pills-woocommerce" type="button" role="tab" aria-controls="pills-woocommerce" aria-selected="true">WooCommerce</button>
                    </li>
                    <li class="nav-item" role="presentation">
    ...
    <!-- integration platform filter wrap @E --> 
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-woocommerce" role="tabpanel" aria-labelledby="pills-woocommerce-tab" tabindex="0">
             <!-- integration area @S -->
            <div class="row">
                <!-- item @S -->
                <div class="col-12 col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="tab-pane fade" id="pills-shopify" role="tabpanel" aria-labelledby="pills-shopify-tab" tabindex="0">
            <!-- integration area @S -->
            <div class="row">
                <!-- item @S -->
                <div class="col-12 col-sm-6 col-md-6 col-lg-4">
