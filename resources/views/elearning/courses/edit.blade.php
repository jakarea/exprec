   ...
   <div class="row">
     <div class="col-lg-12">
       <div class="create-form-wrap">
        ...
        <form action="{{route('course_update', $course->slug)}}" method="POST" class="create-form-box" enctype="multipart/form-data">
          @csrf 
          <div class="row">
               ...
               <div class="row"> 
                 <div class="col-md-12">
                   <div class="form-group form-error">
                     ...
                     <input type="text" placeholder="Enter Course Title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{$course->title}}" id="title">
                ...
                <div class="imgThumbContainer">
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror" placeholder="Enter Short Description">{{ $course->short_description }}</textarea>
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="long_description" id="description" class="form-control @error('long_description') is-invalid @enderror" placeholder="Enter Long Description">{{ $course->long_description }}</textarea>
                 ...
                 <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total module length" name="number_of_module" class="form-control @error('number_of_module') is-invalid @enderror" value="{{ $course->number_of_module }}" id="number_of_module">
                 ...
                 <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total lesson length" name="number_of_lesson" class="form-control @error('number_of_lesson') is-invalid @enderror" value="{{$course->number_of_lesson }}" id="number_of_lesson">
                 ...
                 <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total quiz length" name="number_of_quiz" class="form-control @error('number_of_quiz') is-invalid @enderror" value="{{ $course->number_of_quiz }}" id="number_of_quiz">
                 ...
                 <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total attachment length" name="number_of_attachment" class="form-control @error('number_of_attachment') is-invalid @enderror" value="{{ $course->number_of_attachment }}" id="number_of_attachment">
                 ...
                 <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total video length" name="number_of_video" class="form-control @error('number_of_video') is-invalid @enderror" value="{{ $course->number_of_video }}" id="number_of_video">
