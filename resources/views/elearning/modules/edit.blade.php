   ...
   <div class="row">
     <div class="col-lg-12">
       <div class="create-form-wrap">
        ...
        <form action="{{route('module_update', $module->slug)}}" method="POST" class="create-form-box">
          @csrf 
          <div class="row">
               ...
               <div class="row"> 
                 <div class="col-md-12">
                   <div class="form-group form-error">
                     ...
                     <input type="text" placeholder="Enter Module Title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $module->title }}" id="title">
                 ...
                 <div class="col-md-6">
                   <div class="form-group">
                     ...
                     <input type="text" placeholder="Enter Duration" name="duration" class="form-control @error('duration') is-invalid @enderror" value="{{ $module->duration }}" id="duration">
                 ...
                 <div class="col-md-6">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter Order" name="order" class="form-control @error('order') is-invalid @enderror" value="{{ $module->order }}" id="order">
                 ...
                 <div class="col-md-3">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total lesson length" name="number_of_lesson" class="form-control @error('number_of_lesson') is-invalid @enderror" value="{{$module->number_of_lesson}}" id="number_of_lesson">
                 ...
                 <div class="col-md-3">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total quiz length" name="number_of_quiz" class="form-control @error('number_of_quiz') is-invalid @enderror" value="{{$module->number_of_quiz}}" id="number_of_quiz">
                 ...
                 <div class="col-md-3">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total attachment length" name="number_of_attachment" class="form-control @error('number_of_attachment') is-invalid @enderror" value="{{ $module->number_of_attachment}}" id="number_of_attachment">
                 ...
                 <div class="col-md-3">
                   <div class="form-group">
                     ...
                     <input type="number" placeholder="Enter total video length" name="number_of_video" class="form-control @error('number_of_video') is-invalid @enderror" value="{{ $module->number_of_video }}" id="number_of_video">
