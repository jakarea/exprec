     ...
     <div class="col-lg-12">
       <div class="create-form-wrap">
         <div class="create-form-head">
           ...
           <a href="{{url('/product/category/lists')}}">
             <i class="fa-solid fa-list"></i> All Categories </a>
         </div>
         <!-- create client form start -->
         <form action="{{route('category_update', $category->slug)}}" method="POST" class="create-form-box">
          @csrf 
          <div class="row">
               ...
               <div class="row">
                 <div class="col-md-12">
                   <div class="form-group form-error">
                     ...
                     <input type="text" placeholder="Enter name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $category->name }}">
